...
foreach(_cmake_expected_target IN ITEMS QWindowKit::Core QWindowKit::Widgets QWindowKit::Quick)
...
set_target_properties(QWindowKit::Core PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:uxtheme>;Qt6::Core;Qt6::Gui;\$<LINK_ONLY:Qt6::CorePrivate>;\$<LINK_ONLY:Qt6::GuiPrivate>"
)
...
# Create imported target QWindowKit::Quick
add_library(QWindowKit::Quick STATIC IMPORTED)

set_target_properties(QWindowKit::Quick PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "QWK_QUICK_STATIC"
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/QWindowKit"
  INTERFACE_LINK_LIBRARIES "QWindowKit::Core;Qt6::Core;Qt6::Gui;Qt6::Quick;\$<LINK_ONLY:Qt6::CorePrivate>;\$<LINK_ONLY:Qt6::GuiPrivate>;\$<LINK_ONLY:Qt6::QuickPrivate>"
)

# Load information for each installed configuration.
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/QWindowKitTargets-*.cmake")
